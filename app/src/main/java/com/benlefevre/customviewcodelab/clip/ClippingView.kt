...
class ClippingView @JvmOverloads constructor(
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        drawRoundedClippingExample(canvas)
        drawOutsideClippingExample(canvas)
        drawTranslatedTextExample(canvas)
        drawSkewedClippingExample(canvas)
    ...
    private fun drawSkewedClippingExample(canvas: Canvas) {
        canvas.save()
    ...
    private fun drawRoundedClippingExample(canvas: Canvas) {
        canvas.save()
